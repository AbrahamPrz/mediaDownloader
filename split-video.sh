...
SIZELIMITMB=$(( $SIZELIMIT / 1000000 ))
echo "Size of $FILE = $FILESIZEMB MB"
echo "File size limit: $SIZELIMITMB"

if [ $FILESIZEMB -gt $SIZELIMITMB ]; then
    ...
    echo "File size is smaller than limit specified"
fi